...
/** One line a person can report; never a stack trace. */
 ...
 *
 * Without it, react-router renders its developer-facing default. Whatever
 * breaks, the person gets two ways out that do not depend on the app's own
 * state: a reload, and a plain full-page link back to the start. Nothing is
 * lost either way -- every write is already in Firestore's local queue.
 */
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-3 bg-bg px-6 text-center">
      ...
      <p className="max-w-sm text-sm text-fg-muted">
        This page hit an unexpected error. Your data is safe; reloading usually clears it.
      </p>
